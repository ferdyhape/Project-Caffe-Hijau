                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="fa-solid fa-mug-saucer fa-2x text-gray-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Sum Of Banner</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $bannerCount }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                src="{{ URL::asset('assets/dashboard/img/undraw_posting_photo.svg') }}" alt="...">
                        </div>
