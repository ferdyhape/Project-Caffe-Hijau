describe("login scenario", () => {
    ...
    it("user can login using valid credentials", () => {
        ...
        cy.get(
            ".latest-products > .container > .row > .col-md-12 > .section-heading > h2"
        ).contains("Latest Products");
        cy.get(
            ".best-features > .container > .row > .col-md-12 > .section-heading > h2"
        ).contains("About Cafe Hijau");
    });
    ...
    it("admin can login using valid credentials", () => {
        ...
        cy.get(".dropdown-menu > :nth-child(1) > .dropdown-item").contains(
            "Dashboard Admin"
        );
